...
#lst_check while adding the string “Fruit: ” to the beginning of each element using mapping.
...
b_countries = list(filter(lambda s: "B" in s, countries))

#Below, we have provided a list of tuples that contain the names of Game of
#  Thrones characters. Using list comprehension, create a list of strings called first_names
...
#  are combined into one big list and assigned to the variable opposites if they are both

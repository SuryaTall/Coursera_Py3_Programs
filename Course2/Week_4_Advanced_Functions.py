#Once again, ignore the parameter errors, they work in the Runestone Environment
...
def greeting_(name, greeting="Hello ", excl="!"):
    return greeting + name + excl

print(greeting_("Bob"))
print(greeting_(""))
print(greeting_("Bob", excl="!!!"))
...
def test_(x, y = True, dict1 = {2:3, 4:5, 6:8}):
...
#  if the first input parameter is in the third, dictionary, 

...
def info(name, gender, age, bday_month, hometown):
    tuple2 = name, gender, age, bday_month, hometown
    return tuple2

#Given is the dictionary, gold, which shows the country and the number of
#  gold medals they have earned so far in the 2016 Olympics.
